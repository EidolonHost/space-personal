...
echo -e " "
read -r -p "Would you like to download Centos 6.6? [y/N]" response1
echo -e " "
...
echo -e " "
read -r -p "Would you like to download Centos 7.0? [y/N]" response2
echo -e  " "
...
echo -e " "
read -r -p "Would you like to download Debian 7.8? [y/N]" response3
echo -e " "
...
echo -e " "
read -r -p "Would you like to download Ubuntu 14.04? [y/N]" response4
echo -e " "
